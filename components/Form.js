      ...
      <div>
        ...
        <div className={formStyles.inputWrapper}>
          ...
          <div className={formStyles.dropdown}>
            <div 
              className={open_race_dropdown ? `${formStyles.dropdownHeader} ${formStyles.dropdownSelected}` : `${formStyles.dropdownHeader}` && submit_triggered && !race_filled ? `${formStyles.dropdownHeader} ${formStyles.triggered}` : `${formStyles.dropdownHeader}`}
            ...
            <div 
              className={open_race_dropdown ? `${formStyles.dropdownContent} ${styles.selected}` : `${formStyles.dropdownContent}`} 
            >
              {race_options ? race_options.map(option =>
                <div 
                  key={option}
                  onClick={() => this.selectRace(option)}
                >
                  {option}
                </div>
                )
        ...
        <div className={formStyles.inputWrapper}>
          ...
          <div className={formStyles.dropdown}>
            <div 
              className={open_gender_dropdown ? `${formStyles.dropdownHeader} ${formStyles.dropdownSelected}` : `${formStyles.dropdownHeader}` && submit_triggered && !gender_filled ? `${formStyles.dropdownHeader} ${formStyles.triggered}` : `${formStyles.dropdownHeader}`} 
            ...
            <div 
              className={open_gender_dropdown ? `${formStyles.dropdownContent} ${styles.selected}` : `${formStyles.dropdownContent}` } 
            >
              {gender_options ? gender_options.map(option =>
                <div 
                  key={option}
                  onClick={() => this.selectGender(option)}
                >
                  {option}
                </div>
                )
        ...
        <div className={formStyles.inputWrapper}>
          ...
          <input 
            className={formStyles.inputBox && submit_triggered && !school_filled ? `${formStyles.inputBox} ${formStyles.triggered}` : `${formStyles.inputBox}`} 
            value={school}
        ...
        <div className={formStyles.inputWrapper}>
          ...
          <input 
            className={formStyles.inputBox && submit_triggered && !major_filled ? `${formStyles.inputBox} ${formStyles.triggered}` : `${formStyles.inputBox}`} 
            value={major}
        ...
        <div className={formStyles.inputWrapper}>
          ...
          <input 
            className={formStyles.inputBox && submit_triggered && !grade_filled ? `${formStyles.inputBox} ${formStyles.triggered}` : `${formStyles.inputBox}`} 
            value={grade}
        ...
        <div className={formStyles.inputWrapper}>
          ...
          <div 
            className={formStyles.radio && submit_triggered && !first_time_filled ? `${formStyles.radio} ${formStyles.triggered}` : `${formStyles.radio}`}
          ...
          >
            { first_time === false ? <IoMdRadioButtonOn /> : <IoMdRadioButtonOff /> }
            No
          </div>
        </div>
