...
export default function Faq() {
  const faq = [
    ...
    },
    {
      ...
      answer: 
        <>
          The COVID-19 pandemic caused our event to go fully online. We will mostly be using <a target='_blank' rel='noopener noreferrer' href='https://discord.com/'><span className={styles.link}>Discord</span></a> as our main platform, so be sure to get an account before you apply! An invite link to our server will be sent via email to those who will be participating and will be also made available on the website for those qualified.
        </>
    },
    {
